...
def rasterize_to_pixels_disks(
    ...
    render_colors, render_alphas, first_ids = _RasterizeToPixelsDisks.apply(
        means2d.contiguous(),
        conics.contiguous(),
        colors.contiguous(),
        opacities.contiguous(),
...
class _RasterizeToPixelsDisks(torch.autograd.Function):
    """Rasterize gaussians"""
