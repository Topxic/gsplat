...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("rasterize_to_pixels_disks_fwd", &gsplat::rasterize_to_pixels_disks_fwd_tensor);
    m.def("rasterize_to_pixels_disks_bwd", &gsplat::rasterize_to_pixels_disks_bwd_tensor);
